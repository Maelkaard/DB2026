...
Все возвращаемые результаты должны иметь одинаковый тип.
...
Существует также краткая форма, если все условия - это применение оператора равенства к одному и тому же выражению.
...
10. Отсортировать сотрудников по количеству выполненных заказов.

### Используйте CASE WHEN

11. Выведите статус наличия товара по stock (< 10 - `low`, иначе - 'available').
