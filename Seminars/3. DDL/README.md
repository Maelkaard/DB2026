...
- NOT NULL attr - запрещает атрибуту принимать значение NULL
...
```
- Установить для атрибута значение по умолчанию
```sql
ALTER TABLE name ALTER COLUMN column_name SET DEFAULT expression;
```
- Удалить у атрибута значение по умолчанию
```sql
...
- внешние ключи на обе таблицы

---

### Задание 3
Добавьте в таблицу movies столбец created_at типа TIMESTAMP со значением по умолчанию текущего времени.
...
### Задание 8
Сделайте email обязательным (NOT NULL), если это ещё не сделано.

---

### Задание 9
Добавьте уникальное ограничение на сочетание:
title + release_year

---

### Задание 10
Удалите внешний ключ в таблицу watch на movies, создайте новый с ON DELETE CASCADE.
